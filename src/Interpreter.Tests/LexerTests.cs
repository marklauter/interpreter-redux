...
public sealed class LexerTests(LanguageSpecification language)
{
    ...
    [InlineData(24, "2", 27, 1, TokenType.NumericConstant)]
    ...
    [Theory]
    [InlineData(0, "1.0", 0, 3, TokenType.NumericConstant)]
    [InlineData(1, "", 3, 1, TokenType.Whitespace)]
    [InlineData(2, "2.0", 4, 3, TokenType.NumericConstant)]
    [InlineData(3, "", 7, 1, TokenType.Whitespace)]
    [InlineData(4, "3.0", 8, 3, TokenType.NumericConstant)]
    [InlineData(5, "", 11, 1, TokenType.Whitespace)]
    [InlineData(6, "397.173", 12, 7, TokenType.NumericConstant)]
    [InlineData(7, "", 19, 1, TokenType.Whitespace)]
    [InlineData(8, "89", 20, 2, TokenType.NumericConstant)]
    [InlineData(9, "", 22, 1, TokenType.Whitespace)]
    [InlineData(10, "0.1", 23, 3, TokenType.NumericConstant)]
    [InlineData(11, "", 26, 2, TokenType.Whitespace)]
    [InlineData(12, "1237", 28, 4, TokenType.NumericConstant)]
